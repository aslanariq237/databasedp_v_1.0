    ...
    <div class="car p-3">  
        <div class="car-baru p-3 mb- bg-white rounded">
            <div class="d-flex justify-content-between shadow p-3 mb-1 bg-white rounded">
                <div class="new-tandater">
                    <a class="btn btn-success" href="{{ route('tampil.tandater')}}">New Tandater</a>
                </div>
            ...
            <table class="table w-100">
                ...
                <tbody>
                    @forelse($tandater as $index => $data)
                        <tr>                                          
                            <td>{{ $loop->iteration + ($tandater->currentPage() - 1) * $tandater->perPage() }}</td>
                            <td>
                                {{$data->customer}}
                            </td>
                            ...
                            <td>
                                <a class="btn btn-primary" href="{{ route('TampilId', ['id' => $data->id_tandater])}}">Lihat</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
